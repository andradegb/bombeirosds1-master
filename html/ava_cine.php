...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $comando = $pdo->prepare("INSERT INTO ava_cine
        (nOcorrencia, opcao1, opcao2, opcao3, opcao4, opcao5, opcao6, opcao7, opcao8, opcao9,
        opcao10, opcao11, opcao12, opcao13, opcao14 ) 

        VALUES (:nOcorrencia, :op1, :op2, :op3, :op4, :op5, :op6, :op7, :op8, :op9, :op10, 
        :op11, :op12, :op13, :op14)");
